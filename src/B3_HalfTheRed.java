public class B3_HalfTheRed extends World {
    ...
    public void go() {
        ...
        for (int row = 122; row < 214; row = row + 1) {
            for (int col = 101; col < 381; col++) {
...
//                plane.teleport(col, 488 - row);
        ...
        for (int row = 218; row < 293; row = row + 1) {
            for (int col = 143; col < 340; col++) {
                plane.teleport(col, row);
                ...
                blue = plane.howMuchBlue();
//                plane.teleport(col, 488 - row);
                if (red>200 && red<255 && green > 100 && green < 200 && blue < 100){
                    plane.setPixelColor(100, 100, 255);
                }
